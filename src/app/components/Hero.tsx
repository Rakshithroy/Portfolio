...
export default function Hero() {
  return (
    <main className="w-full">
      ...
      <section
        id="hero"
        className="relative flex flex-col items-center justify-center h-screen px-6 text-center overflow-hidden bg-gradient-to-br from-blue-300 via-purple-300 to-pink-300 dark:from-gray-900 dark:via-gray-800 dark:to-black"
      >
        <motion.h1
